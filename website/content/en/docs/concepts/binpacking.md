---
title: "Bin-Packing and NodeOverlay"
description: "How Karpenter's bin-packing algorithm can affect and sometimes bypass NodeOverlay price adjustments."
weight: 30
---
...
```
Total CPU needed: 10 pods x 12 vCPU = 120 vCPU
```

Karpenter's options:
- **Option A**: 2 nodes x 64 vCPU = 128 vCPU capacity (8 vCPU wasted)
- **Option B**: 1 node x 128 vCPU = 128 vCPU capacity (8 vCPU wasted)
